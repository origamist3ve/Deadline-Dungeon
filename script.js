...
// Great name/idea, it’s very personalized
// Good code, spacing and organization
// You can DRY it up a bit - what if you had one function for all rooms what would that look like?

const rooms = {
  win: {
    title: "You Win!",
    description:
      "As you step out of the final office door, a rush of relief washes over you. The harsh fluorescent lights flicker behind you, and the endless stacks of paperwork are now a distant memory. You made it. You survived the treacherous maze of deadlines, nosy coworkers, and the ever-watchful boss.",
  },
  lose1: {
    title: "Game Over – Caught by the Boss!",
    description:
      "As you try to make your next move, a shadow looms over you. A cold shiver runs down your spine as you slowly turn around—it's the boss, arms crossed, eyes narrowing with suspicion.\n" +
      "\n" +
  ...
  lose2: {
    ...
    description:
      "Your body feels heavy as you trudge through the office, each step slower than the last. The endless meetings, the looming deadlines, the relentless emails—it’s all too much. Your vision blurs, your legs wobble, and with one final exhausted sigh, you collapse into the nearest chair.\n" +
      "\n" +
  ...
  receptionist: {
    title: "Receptionist",
    description:
      "You walk into the office floor and you're seen by the receptionist who clocks you in. She scans your character for the day. How should you act? ",
    choices: {
      choice1: "Stand tall",
      choice2: "Fake cough",
  ...
  cubicles: {
    title: "Cubicle",
    description:
      "You find yourself in a dense labyrinth of cubicles," +
    ...
    afterChoice: {
      choice1:
        "You lean back, stretching theatrically, letting out an exaggerated sigh as if you’ve been toiling away for hours. A nearby coworker nods in sympathy, believing you’re just another overworked corporate warrior. Your act earns you a moment of relief, and the stress seems to ease—but management is now aware of you (Suspicion + 1)",
      choice2:
        "You sit motionless, staring at your inbox. You click refresh. Nothing changes. You click refresh again. The emails remain the same. Time passes in an eternal loop of corporate stagnation. You feel your soul slowly leaving your body, but at least no one notices you. (Health - 1)",
      choice3:
        "You stand up, stretch slightly, and walk over to the water cooler—not too fast, not too slow. You pour a glass, take a sip, nod at a coworker, and return to your desk. No one pays you any mind. No consequences. No changes. Just another day in the machine. (Unchanged)",
    },
  },
  mailRoom: {
    title: "Mail Room",
    description:
      "You step into the mailroom, a dimly lit space tucked away in the farthest reaches of the office. Rows of metal shelves overflow with forgotten packages, dusty memos, and mysterious envelopes addressed to employees who no longer work here. A faint smell of ink, cardboard, and corporate neglect lingers in the air. The hum of an old printer echoes through the room, spitting out paperwork no one will ever read.\n" +
      "\n" +
    ...
    afterChoice: {
      choice1:
        "You step into the shadowy corner of the mailroom and lean against a dusty shelf. For a brief moment, you’re invisible—away from emails, meetings, and the ever-watchful eyes of management. The steady hum of the printer is oddly soothing, and you feel your stress ease just a little.\n" +
        "\n" +
      ...
      choice2:
        "You shuffle through a stack of envelopes, flipping through them as if searching for something important. Your body language screams “busy”, and if anyone walks by, they’ll just assume you’re retrieving an important document. No one questions you, but the dust-covered envelopes remind you how little you belong here. (Health - 1)",
      choice3:
        'You spot a dusty package labeled ‘Derek F. Montgomery’ and immediately decide he was a former employee who vanished under mysterious circumstances. Another package, addressed to "Susan T. Lively," surely belongs to an ex-CEO who faked her own disappearance after uncovering corporate corruption.\n' +
        "\n" +
  ...
  breakRoom: {
    ...
    afterChoice: {
      choice1:
        "You stare at your lunch, pondering the world’s most difficult question. After what feels like a lifetime of indecision, you finally eat… but you’re unsure if it was the right choice. You feel temporarily nourished, but the lingering feeling of doubt hangs over you. (Unchanged)",
      choice2:
        "You engage in the latest water cooler gossip and find yourself surprisingly energized by the drama. The exchange is filled with half-truths and bold assumptions, but it offers a much-needed distraction from the grind. For a moment, you feel more connected to your coworkers. However, you can’t shake the feeling that this gossip might come back to bite you later. (Suspicion + 1)",
      choice3:
        "You scan the bulletin board like you’re uncovering secret office lore. Little snippets of information reveal coworkers’ hobbies, upcoming events, and even the awkwardly cryptic memo about the broken coffee machine. It feels like a safe, low-risk activity, though you can’t help but feel like you’re wasting time. (Health - 1)",
    },
  },
  ...
  restRoom: {
    ...
    afterChoice: {
      choice1:
        "You enter a stall and sit down, taking a moment to relax in the silence. No emails, no phone calls, no managers looming over you. For once, it feels like you can just be yourself, away from the chaos of the office. You let the stillness wash over you. (Unchanged)",
      choice2:
        "You look at yourself in the mirror, practicing your corporate smile. You try to look approachable, friendly, and like you’re totally killing it at work—but the longer you stare, the more it feels like you’re slowly losing your grip on reality. Your smile feels more and more forced, and you wonder if anyone even notices you (Suspicion + 1)",
      choice3:
        'You pull out your phone and quickly glance through your emails, just to stay "on top of things." It feels like an excuse to kill time, but you answer a couple of questions, send out a “quick” reply to a coworker, and maybe scroll through Slack for an urgent message. Of course, the longer you stay, the more you find yourself getting lost in the inbox abyss (Health - 1)',
    },
  },
  ...
  serverRoom: {
    title: "Server Room",
    description:
      "You confidently rearrange some cables, totally sure you’re optimizing performance. A server fan suddenly sounds like a jet engine preparing for takeoff. Huh. Probably nothing. You stretch your back, feeling oddly refreshed—meanwhile, IT is going to have a meltdown.",
    nextRooms: {
      left: "Copy Room",
      right: "Mail Room",
    },
    ...
    afterChoice: {
      choice1:
        "You confidently rearrange some cables, totally sure you’re optimizing performance. A server fan suddenly sounds like a jet engine preparing for takeoff. Huh. Probably nothing. You stretch your back, feeling oddly refreshed—meanwhile, IT is going to have a meltdown. (Suspicion + 1)",
      choice2:
        "You stare at a blinking server light like it’s the meaning of life, hands on hips, nodding thoughtfully. The cold air starts sucking the warmth from your soul, and before long, your fingers feel like frozen fish sticks. Worth it? Probably not. (Health - 1)",
      choice3:
        "Ooooh, red error messages! You squint at the screen, nodding like a seasoned hacker in a movie, but you understand absolutely nothing. After 10 minutes of intense fake analysis, you leave feeling no wiser, but at least no one suspects a thing. (Unchanged)",
    },
  },
};
...
// Leave more meaningful to do's so that you don't forget what the issue was months later
...
// Since we have 6 room functions with very similar code we can do something like:
// const roomGeneration = (imgSrc, room, buttonElements) => {}
// You mentioned this in your project presentation.
const cubicleRoom = () => {
  if (suspicion >= 5) {
    badEnd1();
    return;
...
// Same thing goes here for the next 3 functions - 
// const ending = (img, winRoomData) => {}
const goodEnd = () => {
  right.style.display = "none";
  left.style.display = "none";
